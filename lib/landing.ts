// ===== lib/landing.ts — mock data for Home (ported from references/templates/home-about/home.jsx) =====

export type NeonColor = "cyan" | "magenta" | "yellow" | "green";

export type FeatureIconKind = "GAMEPAD" | "FREE" | "TROPHY" | "ROCKET";

export const FEATURES: { icon: FeatureIconKind; title: string; desc: string; color: NeonColor }[] = [
  {
    icon: "GAMEPAD",
...
export const RECENT_SCORES: { player: string; game: string; score: number; when: string; color: NeonColor }[] = [
